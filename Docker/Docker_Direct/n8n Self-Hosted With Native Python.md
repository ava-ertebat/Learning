...
### ابتدا یک پوشه ایجاد میکنیم و سپس وارد پوشه میشویم sudo mkdir python-runner && cd python-runner
...
قبل از اجرای سرویس‌ها، باید ایمیج رانر خود را بسازید. به دایرکتوری `python-runner` بروید اگر ازش خارج شده اید یا مسیر را مشخص کنید.
